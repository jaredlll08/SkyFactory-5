...
execute as @e[type=player,distance=..64] run colorfulskies color @s cloud f9ffff
execute as @e[type=player,distance=..64] run colorfulskies color @s sun f9ffff
execute as @e[type=player,distance=..64] run colorfulskies color @s moon f9ffff
execute as @e[type=player,distance=..64] run colorfulskies color @s sunrise f9ffff
